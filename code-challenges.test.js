...
describe (accumlatingSum, () =>{
  ...
  // Expected output: []
  expect(accumlatingSum(accountTransactions1)).toEqual([100, 83, 60, 51])
  expect(accumlatingSum(accountTransactions2)).toEqual([250, 161, 261, 165])
  expect(accumlatingSum(accountTransactions3)).toEqual([])
  })
})

// ReferenceError: accumlatingSum is not defined

const accumlatingSum =() =>{
  return 
}
